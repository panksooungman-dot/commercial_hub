            ...
            <div className="absolute inset-0 flex flex-col justify-center px-5 pt-24 pb-10 sm:px-10 sm:pb-12 md:px-14 md:pb-14">
              <div className="max-w-xl sm:max-w-2xl">
                ...
                <div className="animate-hero-fade-up mt-7 flex flex-wrap gap-3 [animation-delay:400ms] sm:mt-9">
                  ...
                  {project.prCenterPhone ? (
                    <a
                      href={`tel:${project.prCenterPhone.replace(/[^0-9+]/g, "")}`}
                      className="inline-flex items-center gap-2.5 border border-accent/60 px-6 py-3.5 text-sm font-semibold text-accent transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-accent/10 sm:px-7 sm:py-4 sm:text-base"
                    >
                      <svg
