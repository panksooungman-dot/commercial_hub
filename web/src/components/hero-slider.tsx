  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center px-5 text-center">
      <div className="max-w-2xl">
        ...
        <h2 className="animate-hero-fade-up mt-2 font-display text-4xl leading-[0.95] font-extrabold tracking-tight text-brand-deep [animation-delay:240ms] sm:mt-5 sm:text-8xl md:text-9xl">
