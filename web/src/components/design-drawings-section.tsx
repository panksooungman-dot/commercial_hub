...
const RAW_SEED: Record<BuildingKey, Record<FloorKey, [string, number, number, number, number][]>> = {
  a: {
    b1: [
      ...
      // 도면 그리드 실측(mm) 기준으로 재보정한 좌표
      ["A101", 16.29, 19.44, 6.35, 13.32],
      ["A102", 25.79, 19.44, 12.64, 13.32],
      ["A105", 34.84, 35.47, 5.46, 18.72],
    ],
    "1f": [
      // 도면 그리드 실측(mm) 기준으로 재보정한 좌표
      ["A116", 16.84, 19.44, 3.67, 13.32],
      ["A115", 20.52, 19.44, 3.67, 13.32],
      ["A114", 24.19, 19.44, 3.67, 13.32],
      ["A113", 27.55, 19.44, 3.04, 13.32],
      ["A112", 30.59, 19.44, 3.04, 13.32],
      ["A111", 34.84, 19.44, 5.46, 13.32],
      ["A110", 55.02, 19.44, 5.46, 13.32],
      ["A109", 60.69, 19.44, 5.86, 13.32],
      ["A108", 65.16, 19.44, 3.09, 13.32],
      ["A107", 68.25, 19.44, 3.09, 13.32],
      ["A106", 75.35, 16.70, 11.11, 7.83],
      ["A105", 75.35, 23.36, 11.11, 5.49],
      ["A102", 76.72, 36.35, 8.39, 4.31],
      ["A120", 20.52, 59.96, 11.02, 4.34],
      ["A122", 17.24, 72.84, 4.46, 7.13],
      ["A130", 47.95, 72.84, 2.89, 7.13],
      ["A134", 59.22, 72.84, 2.93, 7.13],
      ["A135", 62.15, 72.84, 2.93, 7.13],
      ["A137", 68.25, 72.84, 3.09, 7.13],
      ["A138", 71.49, 72.84, 3.40, 7.13],
      ["A139", 74.89, 72.84, 3.40, 7.13],
      ["A140", 78.75, 79.35, 4.32, 5.89],
      ["A141", 78.75, 72.85, 4.32, 7.12],
      ["A142", 78.75, 65.03, 4.32, 8.51],
      ["A143", 75.35, 55.25, 11.11, 11.05],
    ],
    "2f": [
      // 도면 그리드 실측(mm) 기준으로 재보정한 좌표
      ["A212", 17.24, 19.44, 4.46, 13.32],
      ["A211", 22.75, 19.44, 6.56, 13.32],
      ["A210", 29.07, 19.44, 6.08, 13.32],
      ["A209", 37.46, 19.44, 10.70, 13.32],
      ["A208", 49.40, 19.44, 5.79, 13.32],
      ["A207", 55.02, 19.44, 5.46, 13.32],
      ["A206", 60.69, 19.44, 5.86, 13.32],
      ["A205", 66.71, 19.44, 6.18, 13.32],
      ["A204", 73.19, 19.44, 6.79, 13.32],
      ["A213", 20.52, 35.47, 11.02, 18.72],
      ["A215", 55.02, 30.61, 5.46, 9.00],
      ["A216", 20.52, 60.85, 11.02, 16.87],
      ["A217", 17.24, 72.84, 4.46, 7.13],
      ["A218", 22.75, 72.84, 6.56, 7.13],
      ["A224", 60.69, 72.84, 5.86, 7.13],
      ["A226", 73.19, 72.84, 6.79, 7.13],
      ["A227", 78.75, 72.84, 4.32, 7.13],
      ["A203", 78.75, 30.05, 4.32, 7.88],
      ["A202", 78.75, 38.45, 4.32, 8.93],
      ["A201", 78.75, 46.32, 4.32, 6.81],
      ["A229", 75.35, 55.25, 11.11, 11.05],
      ["A228", 78.75, 65.03, 4.32, 8.51],
    ],
  },
  b: {
    b1: [
      ...
      // 도면 그리드 실측(mm) 기준으로 재보정한 좌표
      ["B105", 34.84, 35.47, 5.46, 18.72],
      ["B106", 40.19, 35.47, 5.24, 18.72],
      ["B107", 19.57, 57.27, 12.91, 9.72],
    ],
    "1f": [
      // 도면 그리드 실측(mm) 기준으로 재보정한 좌표
      ["B117", 17.24, 19.44, 4.46, 13.32],
      ["B113", 40.19, 19.44, 5.24, 13.32],
      ["B112", 43.73, 19.44, 1.85, 13.32],
      ["B111", 45.58, 19.44, 1.85, 13.32],
      ["B108", 60.69, 19.44, 5.86, 13.32],
      ["B107", 65.16, 19.44, 3.09, 13.32],
      ["B106", 68.25, 19.44, 3.09, 13.32],
      ["B105", 75.35, 16.70, 11.11, 7.83],
      ["B103", 76.72, 28.11, 8.39, 4.00],
      ["B101", 76.72, 38.77, 8.39, 9.15],
      ["B119", 20.52, 37.54, 11.02, 4.86],
      ["B120", 20.52, 42.40, 11.02, 4.86],
      ["B121", 20.52, 55.10, 11.02, 5.38],
      ["B122", 20.52, 59.96, 11.02, 4.34],
      ["B123", 20.52, 65.71, 11.02, 7.15],
      ["B124", 20.52, 72.84, 11.02, 7.13],
      ["B127", 33.47, 72.84, 2.73, 7.13],
      ["B128", 36.20, 72.84, 2.73, 7.13],
      ["B129", 38.88, 72.84, 2.62, 7.13],
      ["B130", 41.50, 72.84, 2.62, 7.13],
      ["B131", 53.20, 72.84, 1.82, 7.13],
      ["B132", 55.02, 72.84, 1.82, 7.13],
      ["B138", 78.75, 72.84, 4.32, 7.13],
      ["B139", 78.75, 65.03, 4.32, 8.51],
      ["B141", 75.35, 55.25, 11.11, 11.05],
    ],
    "2f": [
      // 도면 그리드 실측(mm) 기준으로 재보정한 좌표
      ["B212", 17.24, 16.70, 4.46, 7.83],
      ["B211", 22.75, 16.70, 6.56, 7.83],
      ["B210", 29.07, 16.70, 6.08, 7.83],
      ["B209", 40.19, 16.70, 5.24, 7.83],
      ["B208", 49.40, 16.70, 5.79, 7.83],
      ["B207", 55.02, 16.70, 5.46, 7.83],
      ["B206", 60.69, 16.70, 5.86, 7.83],
      ["B205", 66.71, 16.70, 6.18, 7.83],
      ["B204", 73.19, 16.70, 6.79, 7.83],
      ["B203", 75.35, 30.05, 11.11, 7.88],
      ["B202", 75.35, 36.28, 11.11, 4.59],
      ["B201", 75.35, 40.75, 11.11, 4.34],
      ["B213", 23.56, 35.47, 17.10, 18.72],
      ["B214", 40.19, 30.61, 5.24, 9.00],
      ["B215", 55.02, 30.61, 5.46, 9.00],
      ["B216", 20.52, 60.85, 11.02, 16.87],
      ["B218", 17.24, 72.84, 4.46, 7.13],
      ["B219", 25.79, 72.84, 12.64, 7.13],
      ["B220", 34.84, 72.84, 5.46, 7.13],
      ["B221", 40.19, 72.84, 5.24, 7.13],
      ["B222", 49.40, 72.84, 5.79, 7.13],
      ["B223", 55.02, 72.84, 5.46, 7.13],
      ["B224", 60.69, 72.84, 5.86, 7.13],
      ["B225", 66.71, 72.84, 6.18, 7.13],
      ["B226", 73.19, 72.84, 6.79, 7.13],
      ["B227", 78.75, 72.84, 4.32, 7.13],
      ["B228", 78.75, 65.71, 4.32, 7.15],
      ["B229", 75.35, 55.25, 11.11, 9.72],
      ["B230", 60.69, 65.71, 5.86, 7.15],
    ],
  },
};
